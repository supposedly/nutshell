...
_auxlist: (auxiliary | symmetried_aux | stationary_symmetried_aux) (_WS (auxiliary | symmetried_aux | stationary_symmetried_aux))*
symmetried_aux: SYMMETRY_NAME "(" auxiliary (_WS auxiliary)* ")"
stationary_symmetried_aux: SYMMETRY_NAME "!" "(" auxiliary (_WS auxiliary)* ")"
...
operation: STATE _MULT INT    -> noref_repeat_int
  | STATE _MULT _expr_no_int  -> noref_int_to_var_length
...
tr_operation: (STATE | reference) _MULT INT    -> repeat_int
  | (STATE | reference) _MULT _tr_expr_no_int  -> int_to_var_length
...
ref_operation: (STATE | reference) _MULT INT    -> repeat_int
  | (STATE | reference) _MULT _ref_expr_no_int  -> int_to_var_length
...
aux_operation: (STATE | aux_reference) _MULT INT    -> repeat_int
  | (STATE | aux_reference) _MULT _aux_expr_no_int  -> int_to_var_length
  | _aux_expr_no_int _MULT INT                      -> repeat_var
  
  | _aux_expr_no_int _subt _aux_expr                -> subt
